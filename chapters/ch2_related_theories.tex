...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{bodytype.jpg}
...
Aluminum & Lightweight, high strength-to-weight ratio, corrosion resistance, machinability & Good strength-to-weight ratio, easy to machine and assemble \\ \hline
Acrylic & Lightweight, easy to fabricate, electrical insulation properties & Easy to cut, suitable for insulation and simple support panels \\ \hline
PLA & Lightweight thermoplastic, suitable for FDM printing, low cost & Easy to print, suitable for curved and customized shapes \\ \hline
\end{tabular}
