...
The robot's pose in a two-dimensional plane is described by the state \( (x, y, \theta) \), where \( (x, y) \) denotes the position and \( \theta \) is the heading angle. The time derivatives of the pose components are given by:
